...
public class GameApp extends GameApplication {
    ...
    protected void initGame() {
        ...
        FXGL.getSettings().devShowBBoxProperty().setValue(true);
        FXGL.getSettings().devBBoxColorProperty().setValue(Color.RED);
        FXGL.getSettings().devEnableDebugCameraProperty().setValue(true);

        FXGL.getSettings().devSensorColorProperty().setValue(Color.RED);
