...
public class PlayerMovementComponent extends Component {
    ...
    private double attackInterval = 1;  // 攻击冷却
...
//                    .put("speed", 150f)
//                    .put("damage", 10f)
//                    .put("center", new Point2D(entity.getPosition().getX()+50,entity.getPosition().getY()+50))
//                    .put("hitCenter",entity.getPosition().add(new Point2D(52f,72f)))
//                    .put("hitRadius", 14.2f)
...
//            );
            FXGL.getGameTimer().runOnceAfter(() -> {
                FXGL.spawn("blade", new SpawnData( entity.getCenter())
                        .put("startPos",  entity.getCenter())
                        .put("damage", 10f)
                        .put("hitCenter",entity.getPosition().add(new Point2D(-5f,30f)))
                        .put("hitRadius", 19f)
                        .put("offsetPos",new Point2D(0f,0f))
                        .put("duration",0.1f));
                FXGL.spawn("blade", new SpawnData( entity.getCenter())
                        .put("startPos",  entity.getCenter())
                        .put("damage", 10f)
                        .put("hitCenter",entity.getPosition().add(new Point2D(90f,30f)))
                        .put("hitRadius", 16f)
                        .put("offsetPos",new Point2D(0f,0f))
                        .put("duration",0.1f));
                FXGL.spawn("blade", new SpawnData( entity.getCenter())
                        .put("startPos",  entity.getCenter())
                        .put("damage", 10f)
                        .put("hitCenter",entity.getPosition().add(new Point2D(40f,30f)))
                        .put("hitRadius", 25f)
                        .put("offsetPos",new Point2D(0f,0f))
                        .put("duration",0.1f));
            }, Duration.seconds(0.3f));
